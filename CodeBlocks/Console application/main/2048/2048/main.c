...
int main()
{
    ...
    do{
        ...
        do{
            ...
            if((highest_number=test_highest())>=win_number)
            {
                win_number++;
                Prinft_Array_2048();
...
void Make_scoretable(void)
{
    int i = 0; long I [2] = {0}; char L [11]={0};
    ...
    while(your_NO<10)
    {
        ...
        {
            strcpy(I,highest_score[(your_NO+1)]);
            strcpy(highest_score[(your_NO+1)],highest_score[your_NO]);
            strcpy(highest_score[your_NO],I);
